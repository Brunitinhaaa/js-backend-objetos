...
console.log("Carrinho de Patricia:");
console.log(patricia.carrinho);
console.log("---------------------");
console.log("Carrinho de Carlos:");
console.log(carlos.carrinho);
console.log("---------------------");
console.log("Carrinho de Renato:");
console.log(renato.carrinho);
console.log("---------------------");
console.log("Carrinho de José:");
console.log(jose.carrinho);
console.log("---------------------");
console.log("Carrinho de Roberto:");
